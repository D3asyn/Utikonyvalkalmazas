			...
			reviews: [
				{
					...
					rating: 5,
					comment:
						"Amazing food and atmosphere! The chef's special was incredible and the service was top-notch.",
					date: "1 week ago",
				},
				{
					id: "r4",
					...
					rating: 4,
					comment:
						"Great food but a bit pricey. The wine selection is excellent though.",
					date: "3 weeks ago",
				},
			],
		},
			...
			reviews: [
				{
					...
					rating: 5,
					comment:
						"An absolutely stunning museum with incredible exhibits!",
					date: "1 month ago",
				},
				{
					id: "r6",
					...
					rating: 4.5,
					comment:
						"Fantastic art collection, but it takes a full day to see everything!",
					date: "2 weeks ago",
				},
			],
		},
			...
			reviews: [
				{
					...
					rating: 5,
					comment:
						"A must-visit if you love theatre! The performances are phenomenal.",
					date: "2 days ago",
				},
				{
					id: "r10",
					...
					rating: 4.8,
					comment:
						"Unforgettable experience! Highly recommend catching a show here.",
					date: "1 week ago",
				},
			],
		},
			...
			reviews: [
				{
					...
					rating: 5,
					comment:
						"Absolutely mesmerizing at night! A must-visit in NYC!",
					date: "1 week ago",
				},
				{
					id: "r12",
					...
					rating: 4,
					comment:
						"Very crowded, but the lights and energy are incredible.",
					date: "2 weeks ago",
				},
			],
		},
			...
			reviews: [
				{
					...
					rating: 5,
					comment:
						"A breathtaking sight! Highly recommend taking the ferry.",
					date: "3 days ago",
				},
				{
					id: "r14",
					...
					rating: 4.5,
					comment:
						"Amazing experience, but book your tickets in advance!",
					date: "2 weeks ago",
				},
			],
		},
			...
			reviews: [
				{
					...
					rating: 5,
					comment:
						"Shopping paradise! So many luxury stores to explore.",
					date: "2 weeks ago",
				},
				{
					id: "r18",
		...
		"10": {
			...
			reviews: [
				...
				},
				{
					...
					rating: 4.5,
					comment:
						"The ceiling and architecture are absolutely stunning!",
					date: "2 weeks ago",
				},
			],
		},
